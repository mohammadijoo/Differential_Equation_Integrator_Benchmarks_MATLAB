...
Scalars characterizing local modal growth, decay, or oscillation of a linearized system.
...
For $\dot{x}=Ax$, modal solutions have the form

$$x(t)=v e^{\lambda t},\qquad Av=\lambda v.$$
...
Conceptual workflow for Eigenvalues:
