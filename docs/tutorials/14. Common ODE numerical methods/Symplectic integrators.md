...
Methods designed to preserve Hamiltonian/geometric structure in mechanical systems.
...
Algorithm sketch for using or implementing Symplectic integrators:
