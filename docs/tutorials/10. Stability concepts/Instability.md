...
The property that small perturbations grow significantly or diverge.
...
Conceptual workflow for Instability:
...
`Stability`, `Lyapunov stability`, `Asymptotic stability`, `Exponential stability`
