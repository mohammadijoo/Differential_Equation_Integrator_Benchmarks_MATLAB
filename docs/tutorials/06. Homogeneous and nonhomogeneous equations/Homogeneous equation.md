...
**Section:** 6. Homogeneous and nonhomogeneous equations

## 1. Meaning

A differential equation with no external forcing/source term, often written with zero right-hand forcing.
...
A forced linear system has the form

$$\dot{x}=Ax+r(t),$$

where $r(t)=0$ gives the homogeneous equation and $r(t)\ne0$ gives the nonhomogeneous equation.
...
A damped oscillator with no input is homogeneous; adding an external force makes it nonhomogeneous.
...
Conceptual workflow for Homogeneous equation:
