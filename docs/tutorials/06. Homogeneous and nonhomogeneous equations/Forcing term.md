...
A prescribed external excitation or input that drives the system.
...
Conceptual workflow for Forcing term:
...
`Homogeneous equation`, `Nonhomogeneous equation`, `Source term`
