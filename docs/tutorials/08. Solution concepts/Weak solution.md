...
**Section:** 8. Solution concepts

## 1. Meaning

A solution satisfying an integral or variational form of the equation, often allowing reduced smoothness.
...
The exact solution is ideal; numerical solutions approximate it. Qualitative concepts such as equilibria and attractors help interpret the solution shape.
...
Conceptual workflow for Weak solution:
