...
**Section:** 19. CFL condition

## 1. Meaning

A nondimensional number measuring how far information travels in one time step relative to the grid spacing.
...
a typical CFL condition is

$$\nu=\frac{|c|\Delta t}{\Delta x}\le \nu_{\max},$$
...
CFL restrictions explain why explicit PDE solvers may require very small time steps on fine grids.
