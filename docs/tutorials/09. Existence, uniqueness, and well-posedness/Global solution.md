...
A solution valid over the full requested domain or for all time.
...
Conceptual workflow for Global solution:
...
`Existence`, `Uniqueness`, `Local solution`, `Lipschitz condition`
