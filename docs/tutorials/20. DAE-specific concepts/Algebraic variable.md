...
A variable determined by algebraic constraints rather than by its own derivative equation.
...
Conceptual workflow for Algebraic variable:
...
`Algebraic constraint`, `Differential variable`, `Index`, `Index-1 DAE`
