...
**Section:** 4. Linear and nonlinear equations

## 1. Meaning

A differential equation in which the unknown function and its derivatives appear linearly.
...
A linear differential equation satisfies superposition:

$$L[\alpha x_1+\beta x_2]=\alpha L[x_1]+\beta L[x_2].$$

A nonlinear equation violates this property.
...
Linear systems allow matrix exponentials and superposition; nonlinear systems may exhibit saturation, bifurcations, chaos, or multiple equilibria.
...
Conceptual workflow for Linear differential equation:
