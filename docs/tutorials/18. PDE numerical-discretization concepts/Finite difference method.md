...
**Section:** 18. PDE numerical-discretization concepts

## 1. Meaning

A method that approximates derivatives using differences between grid values.
...
Spatial discretization turns a continuous PDE into algebraic equations or a large ODE/DAE system.
