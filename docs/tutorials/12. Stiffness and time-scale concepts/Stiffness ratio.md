...
A rough ratio between fastest and slowest relevant decay rates or time scales.
...
A rough stiffness ratio for stable real eigenvalues is
...
Conceptual workflow for Stiffness ratio:
