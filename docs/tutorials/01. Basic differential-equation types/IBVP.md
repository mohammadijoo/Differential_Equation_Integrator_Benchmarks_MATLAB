...
Initial-Boundary Value Problem: a time-dependent boundary-value problem, typical for PDEs.
...
$$u_t=\alpha u_{xx},\quad u(x,0)=u_0(x),\quad u(0,t)=u(L,t)=0.$$
