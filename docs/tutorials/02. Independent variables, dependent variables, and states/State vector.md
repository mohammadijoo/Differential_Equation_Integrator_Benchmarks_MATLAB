...
A vector collecting all state variables needed to describe the system state.
...
Conceptual workflow for State vector:
...
`Independent variable`, `Dependent variable`, `State variable`, `Input`
