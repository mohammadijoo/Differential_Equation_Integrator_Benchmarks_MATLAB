...
An ODE involving second derivatives, common in mechanics and oscillations.
...
Conceptual workflow for Second-order ODE:
...
`Order`, `First-order ODE`, `System of ODEs`, `Dimension`
