...
A differential equation whose dependent variable is a vector of components.
...
Conceptual workflow for Vector equation:
...
`Order`, `First-order ODE`, `Second-order ODE`, `System of ODEs`
