# Akzo-Nobel Chemical Kinetics Problem

## Equation

The Akzo-Nobel problem is a stiff six-variable chemical kinetics benchmark. It is usually written as

$$ y'=f(t,y), \qquad y(t)\in\mathbb{R}^6, $$

where the reaction rates contain nonlinear terms, algebraic-like dependencies, and widely separated coefficients.

### Benchmark type

This is a **stiff chemical kinetics ODE** benchmark proposed for future simulations in this repository.

### Reference solution or diagnostic quantity

No elementary analytical solution is used. Benchmarking should rely on a high-tolerance stiff reference method and diagnostics for positivity and physically admissible concentrations.

### Mathematical properties emphasized

- stiffness
- six-dimensional reaction dynamics
- positivity
...
```text
compute nonlinear reaction rates r1, r2, ...
assemble six concentration derivatives
return dy
```

### Main benchmark lesson

This benchmark is useful for comparing BDF, Rosenbrock, Radau, and linearly implicit solvers on a realistic stiff kinetics problem.

## Proposed MATLAB file

```text
src/benchmarks/benchmark_akzo_nobel_chemical_kinetics.m
```
...
Applications include chemical engineering, reaction kinetics, process simulation, and stiff solver benchmarking.
