...
One delayed SIR variant is

$$ S'(t)=-\beta S(t)I(t-\tau), $$

$$ I'(t)=\beta S(t)I(t-\tau)-\gamma I(t), $$

$$ R'(t)=\gamma I(t). $$

### Benchmark type

This is a **compartmental DDE** benchmark proposed for future simulations in this repository.

### Reference solution or diagnostic quantity

The system tests whether delay interpolation preserves positivity and population balance. Depending on formulation, total population conservation may be approximate or exact.

### Mathematical properties emphasized

- delay in infection term
- positivity
...
```text
I_tau = history_or_interpolated_I(t - tau)
dSdt = -beta*S*I_tau
dIdt = beta*S*I_tau - gamma*I
dRdt = gamma*I
...
This benchmark extends compartmental ODE tests to systems where infection response depends on past states.

## Proposed MATLAB file

```text
src/benchmarks/benchmark_delayed_s_i_r_model.m
```
...
Applications include epidemiology, incubation delays, public-health modeling, and delayed compartmental systems.
