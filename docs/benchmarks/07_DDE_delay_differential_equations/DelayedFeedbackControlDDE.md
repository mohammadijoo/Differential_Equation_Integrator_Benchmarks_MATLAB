# Delayed Feedback Control DDE

## Equation

A simple delayed feedback system is
...
This is a **control system with input delay** benchmark proposed for future simulations in this repository.
...
Delay can destabilize feedback even when the nondelayed closed loop is stable.
...
This benchmark is useful for control-engineering users because it connects numerical integration with delay-induced instability.

## Proposed MATLAB file

```text
src/benchmarks/benchmark_delayed_feedback_control_d_d_e.m
```
...
Applications include control systems, networked control, actuator delays, and feedback stabilization.
