...
This is a **two-species nonlinear PDE** benchmark proposed for future simulations in this repository.

### Reference solution or diagnostic quantity

No closed-form solution is used. The benchmark is judged by pattern morphology, positivity, mass-like behavior, and comparison with high-resolution references.
...
This benchmark is useful for testing PDE solvers on pattern-forming nonlinear dynamics.

## Proposed MATLAB file

```text
src/benchmarks/benchmark_gray_scott_reaction_diffusion.m
```
...
Applications include morphogenesis, chemical pattern formation, materials, and reaction-diffusion simulation.
