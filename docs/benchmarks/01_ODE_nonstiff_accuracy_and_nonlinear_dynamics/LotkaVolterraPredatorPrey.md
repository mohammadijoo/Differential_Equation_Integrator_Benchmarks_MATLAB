...
Here $x(t)$ is prey population and $y(t)$ is predator population.

### Benchmark type

This is a **two-dimensional nonlinear ODE** benchmark proposed for future simulations in this repository.

### Reference solution or diagnostic quantity

The system generally has no elementary closed-form solution, but it has the conserved quantity
...
- positive quadrant invariance
- conserved first integral
- phase error
...
This benchmark separates short-time trajectory accuracy from long-time qualitative behavior and invariant drift.

## Proposed MATLAB file

```text
src/benchmarks/benchmark_lotka_volterra_predator_prey.m
```
...
Applications include ecology, biological interaction models, nonlinear dynamics, and conservative population cycles.
