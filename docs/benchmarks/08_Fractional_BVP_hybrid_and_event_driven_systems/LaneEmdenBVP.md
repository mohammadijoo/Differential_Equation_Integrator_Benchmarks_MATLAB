...
This is a **singular nonlinear BVP/IVP** benchmark proposed for future simulations in this repository.

### Reference solution or diagnostic quantity

The equation is singular at $x=0$, so special initialization or series expansion is needed near the origin.
...
This benchmark tests solver behavior near a removable singularity and nonlinear astrophysical profiles.

## Proposed MATLAB file

```text
src/benchmarks/benchmark_lane_emden_b_v_p.m
```
...
Applications include astrophysics, stellar structure, singular ODEs, and nonlinear boundary-value problems.
