...
A stochastic logistic model is

$$ dX_t=rX_t\left(1-\frac{X_t}{K}\right)dt+\sigma X_t\,dW_t. $$

### Benchmark type

This is a **nonlinear SDE** benchmark proposed for future simulations in this repository.

### Reference solution or diagnostic quantity

The deterministic limit has a known carrying capacity, while the stochastic model tests stability, positivity, and long-time distribution behavior.
...
This benchmark extends deterministic logistic growth to stochastic dynamics and tests statistical accuracy.

## Proposed MATLAB file

```text
src/benchmarks/benchmark_stochastic_logistic_equation.m
```
...
Applications include ecology, stochastic biology, uncertainty quantification, and population modeling.
