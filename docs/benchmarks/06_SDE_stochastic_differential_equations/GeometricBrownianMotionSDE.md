...
This is a **multiplicative-noise SDE** benchmark proposed for future simulations in this repository.
...
For $X_0>0$, the exact process remains positive.
...
This benchmark checks whether SDE integrators preserve positivity and achieve the expected convergence rates.

## Proposed MATLAB file

```text
src/benchmarks/benchmark_geometric_brownian_motion_s_d_e.m
```
...
Applications include financial modeling, stochastic growth, uncertainty propagation, and SDE solver testing.
