...
This is a **linear stochastic differential equation** benchmark proposed for future simulations in this repository.

### Reference solution or diagnostic quantity

The mean and variance are known:
...
This benchmark tests SDE methods using exact statistical moments and pathwise references.

## Proposed MATLAB file

```text
src/benchmarks/benchmark_ornstein_uhlenbeck_s_d_e.m
```
...
Applications include physics, finance, stochastic control, filtering, and noise-driven linear systems.
