...
A charged particle satisfies

$$ m v'=q(E(x,t)+v\times B(x,t)), $$

$$ x'=v. $$

### Benchmark type

This is a **Lorentz-force ODE** benchmark proposed for future simulations in this repository.

### Reference solution or diagnostic quantity

For constant magnetic field and zero electric field, the kinetic energy

$$ K=\frac{1}{2}m|v|^2 $$

is conserved and the trajectory is helical.

### Mathematical properties emphasized

- oscillatory magnetic dynamics
- energy conservation
- large gyrofrequency
...
```text
dxdt = v
dvdt = (q/m)*(E + cross(v,B))
return [dxdt; dvdt]
```

### Main benchmark lesson

This benchmark tests methods for highly oscillatory mechanical systems and motivates Boris-type or volume-preserving integrators.

## Proposed MATLAB file

```text
src/benchmarks/benchmark_charged_particle_in_magnetic_field.m
```
...
Applications include plasma physics, particle-in-cell methods, accelerator physics, and charged-particle tracking.
