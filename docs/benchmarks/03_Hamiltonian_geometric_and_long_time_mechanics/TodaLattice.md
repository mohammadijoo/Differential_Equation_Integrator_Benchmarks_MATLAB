...
The Toda lattice can be written as

$$ q_i'=p_i, $$

$$ p_i'=e^{q_{i-1}-q_i}-e^{q_i-q_{i+1}}. $$

### Benchmark type

This is a **integrable Hamiltonian lattice** benchmark proposed for future simulations in this repository.

### Reference solution or diagnostic quantity

The system is integrable and preserves the Hamiltonian

$$ H=\sum_i \frac{1}{2}p_i^2+\sum_i e^{q_i-q_{i+1}}. $$
...
This benchmark is useful for testing whether numerical methods preserve coherent nonlinear wave structures.

## Proposed MATLAB file

```text
src/benchmarks/benchmark_toda_lattice.m
```
...
Applications include nonlinear lattices, soliton dynamics, statistical mechanics, and geometric integration.
