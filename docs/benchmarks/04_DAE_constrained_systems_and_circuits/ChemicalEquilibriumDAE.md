# Chemical Equilibrium DAE

## Equation

Fast reversible reactions are sometimes modeled by algebraic equilibrium constraints:

$$ y'=f(y,z), $$

$$ 0=g(y,z), $$

where $z$ denotes algebraic species constrained by equilibrium relationships.

### Benchmark type

This is a **reaction DAE with algebraic equilibrium** benchmark proposed for future simulations in this repository.
...
and conservation residuals should remain small throughout the simulation.

### Mathematical properties emphasized

- reaction DAE
- stiff algebraic coupling
- positivity
...
```text
compute differential reaction rates f(y,z)
compute algebraic equilibrium residual g(y,z)
return [f; g]
```

### Main benchmark lesson

This benchmark tests whether DAE solvers handle algebraic chemical constraints without destroying positivity or conservation.

## Proposed MATLAB file

```text
src/benchmarks/benchmark_chemical_equilibrium_d_a_e.m
```
...
Applications include chemical engineering, combustion chemistry, equilibrium reactions, and process modeling.
